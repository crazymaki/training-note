<div class="flex justify-center">
    <div class="w-8/12 bg-white shadow-md rounded-lg p-6">
        <div class="flex justify-between items-center mb-4">
            <button class="text-gray-500">&lt; 前週</button>
            <h2 class="text-xl font-semibold text-gray-800">トレーニング記録</h2>
            <button class="text-gray-500">次週 &gt;</button>
        </div>
